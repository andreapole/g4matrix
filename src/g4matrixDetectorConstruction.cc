...
G4VPhysicalVolume* g4matrixDetectorConstruction::Construct()
{
  ...
  MPT_LYSO->AddConstProperty ("FASTTIMECONSTANT", decaytime * ns);
  MPT_LYSO->AddConstProperty ("YIELDRATIO", 1.0);
  MPT_LYSO->AddConstProperty ("FASTSCINTILLATIONRISETIME", risetime * ns);
  LYSO->SetMaterialPropertiesTable (MPT_LYSO);
  G4cout << "FASTSCINTILLATIONRISETIME = " << risetime << G4endl;
  G4cout << "FASTTIMECONSTANT = " << decaytime << G4endl;
